...
/// root entity in Content/Scenes/start_menu.xml and Content/Scenes/game_over.xml (auto-discovered by name —
...
#pragma warning disable S1192 // Must stay instance methods — they are <Bind> targets in the scene XML
    ...
    public void StartGame() => LoadScene("Scenes/game_scene.xml");

    /// <summary>Bound by the Main Menu button: returns to the start menu.</summary>
    public void BackToMenu() => LoadScene("Scenes/start_menu.xml");
